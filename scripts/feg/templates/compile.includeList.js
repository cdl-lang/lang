...
// %%include%%: <scripts/feg/support/jsSyntaxTree.js>
// %%include%%: <scripts/feg/expression.js>
// %%include%%: <scripts/feg/valueType.js>
// %%include%%: <scripts/feg/predefinedFunctions.js>
// %%include%%: <scripts/feg/elementReference.js>
// %%include%%: <scripts/feg/pathTreeNode.js>
// %%include%%: <scripts/feg/areaTemplate.js>
// %%include%%: <scripts/feg/functionNode.js>
// %%include%%: <scripts/feg/queryCompiler.js>
// %%include%%: <scripts/feg/buildFunctionNode.js>
// %%include%%: <scripts/feg/testElement.js>
// %%include%%: <scripts/feg/functionGraph.js>
// %%include%%: <scripts/feg/attributeDescription.js>
