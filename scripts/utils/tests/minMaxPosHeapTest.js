...
function runTest(timeTest) {
    ...
    for (var mc = 0; mc !== 250; mc++) {
        ...
        var h = new MinMaxPosHeap(function (a, b) { return a.key - b.key; },
                                  "val");
        ...
        for (var ic = 0; ic !== 1000; ic++) {
            ...
            if (rnd < 0.1) {
                ...
                for (i = 0; i < nrToAdd; i++) {
                    ...
                    arr.push({key: newVal, val: newVal});
                }
                ...
                if (!h.isEmpty()) {
                    ...
                    if (!(poppedMax.key <= lastMax)) {
                        console.log("error popMax");
                        MinMaxHeap.errorCount++;
                    }
                    lastMax = poppedMax.key;
                    nrPopMax++;
                }
            } else {
                if (!h.isEmpty()) {
            ...
            if (testLog && !h.isEmpty()) console.log("heap", h.heap.map(function(e){return e&&e.key;}));
